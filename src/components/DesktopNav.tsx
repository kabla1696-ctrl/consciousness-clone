...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/personality', icon: '🧬', label: 'Personality Quiz' },
      { href: '/mood', icon: '🎭', label: 'Mood Tracker' },
      { href: '/dream-lab', icon: '🧪', label: 'Dream Lab' },
      { href: '/voice', icon: '🎤', label: 'Voice Clone' },
      { href: '/clone-diary', icon: '📔', label: 'Clone Diary' },
      { href: '/clone-podcast', icon: '🎙️', label: 'Clone Podcast' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/consciousness-backup', icon: '☁️', label: 'Backup' },
      { href: '/clone-settings', icon: '⚙️', label: 'Settings' },
    ],
  },
]
