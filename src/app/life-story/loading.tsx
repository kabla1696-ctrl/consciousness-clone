...
export default function LifeStoryLoading() {
  return (
    <main className="min-h-screen pb-24 md:pb-8" style={{ background: '#050510' }}>
      ...
      <div className="px-4 py-6 space-y-6 relative z-10">
        {/* Book cover skeleton */}
        <div className="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-8 text-center space-y-5">
          <div className="h-20 w-20 mx-auto rounded-2xl bg-white/5 shimmer" />
          <div className="h-8 w-48 mx-auto rounded bg-white/5 shimmer" />
          <div className="space-y-2">
            <div className="h-3.5 w-full rounded bg-white/3 shimmer" />
            <div className="h-3.5 w-3/5 mx-auto rounded bg-white/3 shimmer" />
          </div>
          <div className="h-12 w-48 mx-auto rounded-xl bg-white/5 shimmer" />
        </div>

        {/* Memory count skeleton */}
        <div className="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-4 flex items-center justify-between">
          <div className="h-4 w-32 rounded bg-white/5 shimmer" />
          <div className="h-6 w-12 rounded bg-white/5 shimmer" />
        </div>
