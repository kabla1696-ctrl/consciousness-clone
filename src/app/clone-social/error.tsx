'use client'
export default function CloneSocialError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-screen bg-[#050510] flex items-center justify-center p-6">
      <div className="text-center max-w-sm">
        <div className="text-6xl mb-4">👥❌</div>
        <h2 className="text-xl font-semibold text-white mb-2">Feed Error</h2>
        <p className="text-white/40 text-sm mb-6">The social feed couldn&apos;t load.</p>
