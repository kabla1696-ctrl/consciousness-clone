...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    'blog': 'The Consciousness Blog', 'articles': 'Insights on digital immortality, AI consciousness, and preserving what makes you — you.',
    'read more': 'read', 'latest posts': 'Stay Updated',
    'privacy policy': 'Privacy Policy', 'data collection': 'Information We Collect', 'cookies': 'Cookies', 'your rights': 'Your Rights',
    'terms of service': 'Terms of Service', 'acceptable use': 'Acceptable Use', 'liability': 'Limitation of Liability', 'termination': 'Termination',
    'refer and earn': 'Refer Friends, Earn Rewards', 'invite friends': 'Share Consciousness Clone and earn points & badges',
    'rewards': 'Reward Tiers', 'share link': 'Share Your Clone',
    'share clone': 'Share Your Clone', 'let others meet': 'Let others interact with your digital consciousness',
    'copy link': 'Your Public Link',
    'display name': 'Display Name', 'bio': 'Bio', 'public': 'Make Profile Public',
    'voice clone': 'Voice Clone', 'make clone sound': 'Make your clone sound exactly like you',
    'voice sample': 'How Voice Cloning Works',
    'home screen': 'Customize your home screen widgets', 'quick access': 'How to Install', 'customize': 'Widget Themes',
 ...
 'final message': 'Final Message', 'for the world': 'For the World',
